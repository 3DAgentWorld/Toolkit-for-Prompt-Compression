...
if __name__ == '__main__':
    ...
    compressor = LLMLinguaCompressor(device_map="cpu", model_name="/home/hdd/lijinyi/CompressionInAvalon/src/models/meta-llama/Llama-2-7b-chat-hf", token="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")
